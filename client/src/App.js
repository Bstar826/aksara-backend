...
function App() {
  ...
  const generate = async() =>{
    ...
    document.getElementById('visible').className='p-2 text-white bg-blue-300 rounded-md';
    ...
    <div className="flex flex-col items-center justify-center gap-12 px-10 py-8">
      ...
      <div className='flex flex-col gap-5 md:flex-row lg:w-4/5'>
        ...
        <div className='flex flex-col items-center justify-center gap-6 px-6 py-4 bg-white rounded-lg md:w-1/2 g lightShadow'>
          ...
          <input id="stringInput" className='w-10/12 p-2 rounded-md bg-back' onChange={handleOnChange} placeholder='Enter URL Here'/>
          <div className='flex flex-col justify-start w-4/5 gap-6'>
            <div className='flex justify-start gap-2 bg-white w-100'>
              ...
              <label className='text-gray-800 bg-white '>Customize the color</label>
            </div>
            <div className='flex gap-2 bg-white pointer'>
              <input type='color' className='bg-white '/>
              <label className='text-gray-800 bg-white'>Customize the Background Color</label>
            </div>
          </div>
          ...
          <button onClick={generate} className='p-2 text-white bg-blue-300 rounded-md hover:bg-sky-500'>Generate</button>
        </div>
